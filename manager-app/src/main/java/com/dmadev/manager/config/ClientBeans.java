package com.dmadev.manager.config;

import com.dmadev.manager.client.RestClientProductsRestClient;
import com.dmadev.manager.security.OAuthClientHttpRequestInterceptor;
